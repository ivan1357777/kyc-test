...
const Login = () => {
  ...
  const handleLoginSubmit = async (e) => {
    ...
    try {
      ...
      if (data.error) {
        ...
        // Mark the user as logged in and store their email
  ...
  const handleSecuritySubmit = (e) => {
    ...
    // Optionally, remove the expectedSecurityKey from localStorage since it's no longer needed
    // localStorage.removeItem('expectedSecurityKey');
